...
export const metadata: Metadata = buildMetadata({
  title: "Contact Guest Squad | Book a Coverage Review",
  description:
    "Book a 30-minute coverage review or send your property details. Guest Squad responds within one business day.",
  path: "/contact",
});
