...
export const hotelAnsweringServiceData: ServiceDetailData = {
  ...
  faqs: [
    ...
    { q: "How is this different from your Reservation Support service?", a: "[Reservation Support](/services/reservation-support) focuses on bookings, quotes, and modifications. Hotel Answering Service is the broader call-answering layer, including general questions and overflow, and the two are often used together for complete phone coverage." },
    ...
    { q: "Can you cover just our busiest hours, not all day?", a: "Yes. Many clients start with peak-hour overflow coverage during check-in and check-out rushes rather than committing to full-day coverage. For overnight gaps, [after-hours support](/services/after-hours-support) covers that window separately." },
...
export const reservationSupportData: ServiceDetailData = {
  ...
  faqs: [
    ...
    { q: "How does answering reservation calls directly reduce OTA commission costs?", a: "When a guest who would otherwise book through Booking.com or Expedia calls your direct number and a trained agent picks up, the booking is confirmed direct, with no OTA commission. Consistent phone coverage during hours when your team cannot answer is one of the most straightforward ways to shift your booking source mix over time. If your OTA inboxes also need coverage, [OTA Inbox Management](/services/ota-inbox-management) handles that separately." },
    ...
    { q: "Can Guest Squad help reduce missed direct bookings?", a: "Yes. The main source of missed direct bookings is unanswered calls and slow responses to inquiries. Use the [Missed Booking Revenue Calculator](/resources/missed-booking-calculator) to estimate how much that gap is costing you each month." },
...
export const guestMessagingData: ServiceDetailData = {
  ...
  faqs: [
    ...
    { q: "Which channels do you actually cover?", a: "SMS, WhatsApp, email, and in-app messaging from your PMS or guest-messaging platform. OTA messaging (Booking.com, Expedia, Airbnb) is covered under our separate [OTA Inbox Management](/services/ota-inbox-management) service." },
    ...
    { q: "Can Guest Squad respond to WhatsApp and SMS messages overnight?", a: "Yes. Overnight message coverage is one of the most common reasons clients use this service. Guests who message after hours receive a real response instead of silence or a generic auto-reply. If you need broader overnight call coverage too, [after-hours support](/services/after-hours-support) covers that alongside messaging." },
...
export const afterHoursData: ServiceDetailData = {
  ...
  faqs: [
    ...
    { q: "Do we still need a night auditor?", a: "We cover guest-facing calls and messages. The financial night-audit function is a separate service under [Back-Office Operations](/services/back-office-operations) if you need that covered too." },
