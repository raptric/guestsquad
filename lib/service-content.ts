...
export const afterHoursData: ServiceDetailData = {
  ...
  faqs: [
    ...
    { q: "Is this cheaper than hiring overnight staff?", a: "Typically yes. Outsourced after-hours coverage commonly runs 30 to 50 percent below the cost of staffing the same hours in-house, since you are not paying for a full overnight shift." },
